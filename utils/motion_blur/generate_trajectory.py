...
class Trajectory(object):
    def __init__(self, canvas=64, iters=2000, max_len=60, expl=None, path_to_save=None):
        ...
        at inverting the particle velocity may arise, mimicking a sudden movement that occurs when the user presses
        ...
        2011] can be obtained by setting anxiety to 0 when no impulsive changes occur
