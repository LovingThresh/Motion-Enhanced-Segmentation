# -*- coding: utf-8 -*-
# @Time    : 2022/7/15 17:00
# @Author  : LiuYe
# @Email   : csu1704liuye@163.com | sy2113205@buaa.edu.cn
# @File    : VisionTransformer.py
# @Software: PyCharm
import math
import logging
import warnings
...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        q, k, v = qkv.unbind(0)  # make torch-script happy (cannot use tensor as tuple) 将tensor的某一维度转换为元组tuple
...
class LayerScale(nn.Module):
    def __init__(self, dim, init_values=1e-5, inplace=False):
        ...
        self.gamma = nn.Parameter(init_values * torch.ones(dim))  # 可学习参数，这一步先进行了初始化
...
class ResPostBlock(nn.Module):
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0., init_values=None,
                 drop_path=0., act_layer=nn.GELU, norm_layer=nn.LayerNorm):
        super(ResPostBlock, self).__init__()
